...
#         file_name = f'results/HC_best_{dimension}_{function}.txt'
...
# for function in functions_name:
#     for dimension in function_dimensions:
#         file_name = f'results/HC_first_{dimension}_{function}.txt'
#         mean_results, std, mean_execution_time = statistics(file_name)
...
for function in functions_name:
    for dimension in function_dimensions:
        file_name = f'results/HC_worst_{dimension}_{function}.txt'
        mean_results, std, mean_execution_time = statistics(file_name)
        line = [function, dimension, "HC worst", str(
            mean_results), str(std), str(mean_execution_time), '\n']
        f.write(','.join(line))
